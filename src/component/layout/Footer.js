...
function Footer () {
  return (
    <div className="py-5 text-white" style={{backgroundColor:'#222831'}}>
        ...
        <div className="row">
          ...
          <div className="col-12 col-md-3">
            ...
            <div className="d-flex gap-3 mb-3">
              <LocationOn/>
              <div className="color-ffffffb3">203 Fake St. Mountain View, San Francisco, California, USA</div>
            </div>
            <div className="d-flex gap-3 mb-3">
              <Call/>
              <div className="color-ffffffb3">+2 392 3929 210</div>
            </div>
            <div className="d-flex gap-3 mb-3">
              <Email/>
              <div className="color-ffffffb3">info@yourdomain.com</div>
            </div>
          </div>
        </div>
      </div>
